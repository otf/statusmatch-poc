...
var $author$project$Main$initModel = {programs: _List_Nil, searchText: ''};
...
var $author$project$Main$LoadPrograms = function (a) {
	return {$: 'LoadPrograms', a: a};
};
...
var $author$project$Main$programsDecoder = $elm$json$Json$Decode$list($elm$json$Json$Decode$string);
var $author$project$Main$fetchPrograms = function (text) {
	return $elm$http$Http$get(
		{
			expect: A2($elm$http$Http$expectJson, $author$project$Main$LoadPrograms, $author$project$Main$programsDecoder),
			url: 'api/programs/search?text=' + text
		});
};
var $author$project$Main$update = F2(
	function (msg, model) {
		if (msg.$ === 'GotSearchText') {
			var text = msg.a;
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{searchText: text}),
				$author$project$Main$fetchPrograms(text));
		} else {
			if (msg.a.$ === 'Ok') {
				var programs = msg.a.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{programs: programs}),
...
var $mdgriffith$elm_ui$Element$layout = $mdgriffith$elm_ui$Element$layoutWith(
	{options: _List_Nil});
var $author$project$Main$GotSearchText = function (a) {
	return {$: 'GotSearchText', a: a};
};
...
var $author$project$Main$viewPrograms = function (programs) {
	var children = A2(
		$elm$core$List$map,
		function (p) {
			return $mdgriffith$elm_ui$Element$text(p);
		},
		programs);
	return A2($mdgriffith$elm_ui$Element$column, _List_Nil, children);
};
var $author$project$Main$viewFrom = function (model) {
	return A2(
			...
			[
				...
				_List_Nil,
				{
					label: A2(
						...
						_List_Nil,
						$mdgriffith$elm_ui$Element$text('Search a program.')),
					onChange: $author$project$Main$GotSearchText,
					placeholder: $elm$core$Maybe$Nothing,
					text: model.searchText
				}),
				$author$project$Main$viewPrograms(model.programs)
			]));
};
var $author$project$Main$view = function (model) {
	return A2(
		...
		_List_Nil,
		$author$project$Main$viewFrom(model));
};
var $author$project$Main$main = $elm$browser$Browser$element(
	{init: $author$project$Main$init, subscriptions: $author$project$Main$subscriptions, update: $author$project$Main$update, view: $author$project$Main$view});
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"GotSearchText":["String.String"],"LoadPrograms":["Result.Result Http.Error (List.List String.String)"]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}},"List.List":{"args":["a"],"tags":{}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"String.String":{"args":[],"tags":{"String":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}}}}})}});}(this));